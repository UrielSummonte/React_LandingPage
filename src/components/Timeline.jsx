    ...
    const Eventos = [
        {
          ...
          description: "Altaïr Ibn-La'Ahad lucha contra los Templarios en Tierra Santa.",
        },
        {
          year: "1476",
          title: "Renacimiento Italiano",
          description: "Ezio Auditore da Firenze inicia su venganza contra los conspiradores.",
        },
        {
          year: "1715",
          title: "Edad de Oro de la Piratería",
          description: "Edward Kenway navega por el Caribe buscando fortuna y libertad.",
        },
        {
          year: "1789",
          title: "Revolución Francesa",
          description: "Arno Dorian busca redención en medio del caos revolucionario en París.",
        },
        {
          year: "1868",
          title: "Revolución Industrial",
          description: "Los gemelos Frye luchan por liberar Londres del control Templario.",
        },
        {
          year: "2012",
          title: "Era Moderna",
          description: "Desmond Miles revive las memorias de sus antepasados para salvar el mundo.",
        },
      ]
                    ...
                    {Eventos.map((event, index) => (
                        <div key={index} className={`relative ${index % 2 === 0 ? "md:pr-8" : "md:pl-8 md:col-start-2"}`}>
                            <div className='bg-ac-dark p-6 rounded-lg border border-ac-gold'>
                                ...
                                <h3 className='text-xl font-semibold text-ac-gold'>{event.title}</h3>
